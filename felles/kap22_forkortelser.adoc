...
[#VHR]
*VHR*: Very High Resolution, satellittbilder med høy romlig oppløsning (https://dataspace.copernicus.eu/explore-data/data-collections/copernicus-contributing-missions/collections-description/VHR-IMAGE-2021)[Optical VHR coverage over Europe 2021])