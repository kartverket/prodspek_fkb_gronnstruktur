...
:metadata-url: https://kartkatalog.geonorge.no/metadata/fkb-groennstruktur/86d6201a-4e0b-4f61-a1dc-c94164cfd160?search=gr%C3%B8nn
:dokumentstatus: 2
...
include::kap13_normativ_ref.adoc[]
