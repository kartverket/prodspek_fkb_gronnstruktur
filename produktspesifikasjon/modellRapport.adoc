...
=== «ApplicationSchema» FKB Grønnstruktur-1.0
**Definisjon:** datamodell for produktspesifikasjonenen FKB-Grønnstruktur.
Produktet viser områder med vegetasjon innen bebygde områder, inkludert hytteområder
...
|targetNamespace 
|http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Gronnstruktur/1.0 
...
Den unike identifikatoren er unik for kartobjektet og skal ikke endres i kartobjektets levetid. Dette må ikke forveksles med en tematisk identifikator, som unikt identifiserer et objekt i virkeligheten. 
...
iii. Når avgrensingen til en flate endres, skal flateobjektet få ny oppdateringsdato.
...
Merknad: Hvert objekt består som regel av flere trær med lik høyde.
...
|Definisjon: 
|andel av arealfiguren som overlapper FKB-datasettene Bygning, Veg, Vann eller jordbruksarealer i AR5 
