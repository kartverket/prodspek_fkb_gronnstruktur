...
//*link:{uml-url}[HTML-visning av UML-modell]*

//*Nyeste versjon finnes på*: {prodspek-url} +
//- {uml-url}[HTML-visning av UML-modellen] +

ifeval::["{dokumentnivå}" == "TILGODKJENNING"]
IMPORTANT: Dette forslaget til standard venter på godkjenning i Standardiseringskomiteen for Geomatikk. Standarden er ikke vedtatt.
endif::[]
