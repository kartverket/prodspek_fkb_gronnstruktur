...
{fkbdatasett} inneholder data fra flere kilder, se <<Datafangts>> og <<Datavedlikehold>> i denne spesifikasjonen.
...
Toleransekravene i Tabell 2 avspeiler forventet kvalitet i første utgave grønnstrukturkartet. Det tilstrebes at toleransekravene vil bli strengere i fremtidige versjoner av grønnstrukturkartet.
...
Det settes ikke krav til stedfestingsnøyaktighet for Bunn, Busk, Tre og Grå. I stedet settes det krav til klasseriktighet, altså at Bunn, Busk, Tre og Grå er riktig klassifisert slik at Grå ikke klassifiseres som grønt (Busk, Busk, Tre) og motsatt, se Tabell 2.
