...
[NOTE]
====
NDH oppdateres med nye laserdata fortløpende. På grunn av tidsgap mellom NDH og VHR, kan klassifiseringen forringes. Dette tidsgapet må også tas med i vurderingen i kartkontrollen slik at man sammnelikner {fkbdatasett} med f.eks. ortofoto med bildedato (fotoår) så nær datafangstdato for NDH. Flytte dette til kartkontrollrapporten, og ev. inkl. i neste versjon av <<G>>.
====
...
Toleransekravene i Tabell 2 avspeiler forventet kvalitet i Grønnstrukturkartet i 2025. Toleransekravene vil bli strengere (nærmest halveres) i neste versjon av Grønnstrukturkartet i 2028.
